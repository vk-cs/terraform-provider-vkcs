...
func TestAccLBL7Rule_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigBasic, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
			...
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigUpdate1, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBL7RuleExists("vkcs_lb_l7rule.l7rule_1", &l7rule),
					resource.TestCheckResourceAttr(
			...
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigUpdate2, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBL7RuleExists("vkcs_lb_l7rule.l7rule_1", &l7rule),
					resource.TestCheckResourceAttr(
						"vkcs_lb_l7rule.l7rule_1", "type", "HOST_NAME"),
			...
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigUpdate3, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBL7RuleExists("vkcs_lb_l7rule.l7rule_1", &l7rule),
					resource.TestCheckResourceAttr(
			...
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigUpdate4, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBL7RuleExists("vkcs_lb_l7rule.l7rule_1", &l7rule),
					resource.TestCheckResourceAttr(
						"vkcs_lb_l7rule.l7rule_1", "type", "HOST_NAME"),
			...
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigUpdate5, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBL7RuleExists("vkcs_lb_l7rule.l7rule_1", &l7rule),
					resource.TestCheckResourceAttr(
			...
			{
				Config: acctest.AccTestRenderConfig(testAccCheckLbL7RuleConfigUpdate6, map[string]string{"TestAccCheckLbL7RuleConfig": testAccCheckLbL7RuleConfig}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBL7RuleExists("vkcs_lb_l7rule.l7rule_1", &l7rule),
					resource.TestCheckResourceAttr(
						"vkcs_lb_l7rule.l7rule_1", "type", "PATH"),
