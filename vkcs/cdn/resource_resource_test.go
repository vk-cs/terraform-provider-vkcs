...
func TestAccCDNResourceResource_updateSSLCertificate(t *testing.T) {
	nameSuffix := acctest.GenerateNameSuffix()
	baseName := "tfacc-resource-base-" + nameSuffix
	cname := "tfacc-update-" + nameSuffix + ".vk.com"
	oldCertName := "tfacc-resource-update-old-" + nameSuffix
	newCertName := "tfacc-resource-update-new-" + nameSuffix
