...
func OriginGroupDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"backup": schema.BoolAttribute{
							...
							MarkdownDescription: "Defines whether the origin is a backup, meaning that it will not be used until one of active origins become unavailable.",
						},
						"enabled": schema.BoolAttribute{
							Computed:            true,
							Description:         "Enables or disables an origin source in the origin group.",
							MarkdownDescription: "Enables or disables an origin source in the origin group.",
						},
			...
			"use_next": schema.BoolAttribute{
				Computed:            true,
				Description:         "Defines whether to use the next origin from the origin group if origin responds with 4XX or 5XX codes.",
				MarkdownDescription: "Defines whether to use the next origin from the origin group if origin responds with 4XX or 5XX codes.",
			},
		},
	}
}
