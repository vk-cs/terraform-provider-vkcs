...
func TestNewClusterName(t *testing.T) {
	tests := []struct {
		...
		// Invalid names (spec symbols)
		{
			...
			input:         "Cluster",
			expectedError: errors.New("Cluster name must consist of lower case Latin alphanumeric characters, '-', must start and end with Latin alphanumeric character, and must not contain consecutive hyphens, got invalid characters: ['C']"),
		},
		{
			name:          "contains special characters",
			input:         "cluster@1",
			expectedError: errors.New("Cluster name must consist of lower case Latin alphanumeric characters, '-', must start and end with Latin alphanumeric character, and must not contain consecutive hyphens, got invalid characters: ['@']"),
		},
		{
		...
		},
		{
			...
			input:         "-cluster",
			expectedError: errors.New("Cluster name must consist of lower case Latin alphanumeric characters, '-', must start and end with Latin alphanumeric character, and must not contain consecutive hyphens"),
		},
		{
