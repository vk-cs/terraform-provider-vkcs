...
const (
	...
	createClusterPollIntervalV2 = 30 * time.Second
...
func (r *kubernetesClusterV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating Managed K8S API client for resource vkcs_kubernetes_cluster_v2", err.Error())
		return
	}
