...
func TestAccKubernetesSecurityPolicyV2_basic(t *testing.T) {
	...
	clusterName := "tfacc-csp-basic-v2-" + acctest_helper.RandStringFromCharSet(3, acctest_helper.CharSetAlphaNum)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckKubernetesSecurityPolicyV2Exists("vkcs_kubernetes_security_policy_v2.base"),
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_security_policy_v2.base", "cluster_id", "vkcs_kubernetes_cluster_v2.base", "id"),
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_security_policy_v2.base", "security_policy_template_id", "data.vkcs_kubernetes_security_policy_template_v2.k8scontainerrequests", "id"),

					resource.TestCheckResourceAttr("vkcs_kubernetes_security_policy_v2.base", "namespace", "*"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_security_policy_v2.base", "enabled", "true"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_security_policy_v2.base", "policy_settings", `{"cpu":"1000m","excludedNamespaces":["prometheus"],"memory":"2Gi"}`),

					resource.TestCheckResourceAttrSet("vkcs_kubernetes_security_policy_v2.base", "id"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_security_policy_v2.base", "region"),
				),
			},
			acctest.ImportStep("vkcs_kubernetes_security_policy_v2.base"),
		},
	})
}
...
func TestAccKubernetesSecurityPolicyV2_full(t *testing.T) {
	...
	clusterName := "tfacc-csp-full-v2-" + acctest_helper.RandStringFromCharSet(3, acctest_helper.CharSetAlphaNum)
	clusterConfig := acctest.AccTestRenderConfig(testAccKubernetesClusterV2Base, map[string]string{
		"TestAccKubernetesNetworkingBase": testAccKubernetesNetworkingBase,
		"ClusterName":                     clusterName,
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_security_policy_v2.full", "security_policy_template_id", "data.vkcs_kubernetes_security_policy_template_v2.k8scontainerrequests", "id"),
...
func TestAccKubernetesSecurityPolicyV2_update(t *testing.T) {
	...
	clusterName := "tfacc-csp-upd-v2-" + acctest_helper.RandStringFromCharSet(3, acctest_helper.CharSetAlphaNum)
	clusterConfig := acctest.AccTestRenderConfig(testAccKubernetesClusterV2Base, map[string]string{
		"TestAccKubernetesNetworkingBase": testAccKubernetesNetworkingBase,
		"ClusterName":                     clusterName,
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_security_policy_v2.update", "security_policy_template_id", "data.vkcs_kubernetes_security_policy_template_v2.k8scontainerrequests", "id"),
...
data "vkcs_kubernetes_security_policy_template_v2" "k8scontainerrequests" {
...
resource "vkcs_kubernetes_security_policy_v2" "base" {
  ...
  security_policy_template_id = data.vkcs_kubernetes_security_policy_template_v2.k8scontainerrequests.id
  namespace                   = "*"
