	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"enable_public_ip": schema.BoolAttribute{
				...
				MarkdownDescription: "Enable public IP for the cluster.",
			},
			...
			"k8s_config": schema.StringAttribute{
				...
				MarkdownDescription: "Contents of the kubeconfig file.",
			},
			...
			"master_flavor": schema.StringAttribute{
				...
				MarkdownDescription: "Flavor UUID for master nodes.",
			},
			...
			"network_id": schema.StringAttribute{
				...
				MarkdownDescription: "ID of the cluster's network.",
			},
			"network_plugin": schema.StringAttribute{
				Computed:            true,
				Description:         "Network plugin.",
				MarkdownDescription: "Network plugin.",
			},
			...
			"region": schema.StringAttribute{
				...
				MarkdownDescription: "The region in which to obtain the Container Infra client. If omitted, the `region` argument of the provider is used.",
			},
