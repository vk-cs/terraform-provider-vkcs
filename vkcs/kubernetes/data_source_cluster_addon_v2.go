...
import (
	...
	dskubecladv2 "github.com/vk-cs/terraform-provider-vkcs/vkcs/kubernetes/datasource_kubernetes_cluster_addon_v2"
)
...
func (d *kubernetesClusterAddonV2DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = dskubecladv2.KubernetesClusterAddonV2DataSourceSchema(ctx)
}
...
func (d *kubernetesClusterAddonV2DataSource) ValidateConfig(ctx context.Context, req datasource.ValidateConfigRequest, resp *datasource.ValidateConfigResponse) {
	var data dskubecladv2.KubernetesClusterAddonV2Model
...
func (d *kubernetesClusterAddonV2DataSource) getClusterAddon(client *gophercloud.ServiceClient, data *dskubecladv2.KubernetesClusterAddonV2Model) (clusterAddon *addons.ClusterAddon, diags diag.Diagnostics) {
	if !data.Id.IsNull() {
