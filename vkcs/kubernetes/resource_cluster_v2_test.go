		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.base", "master_flavor", "data.vkcs_compute_flavor.base", "id"),
...
resource "vkcs_kubernetes_node_group_v2" "upgrade" {
  ...
  node_flavor              = data.vkcs_compute_flavor.base.id
