...
func TestAccKubernetesClusterV2_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: acctest.AccTestRenderConfig(testAccKubernetesClusterV2Base, map[string]string{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "name", clusterName),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "version", "v1.34.2"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "cluster_type", "standard"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "availability_zones.#", "1"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "availability_zones.0", "MS1"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "master_count", "1"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "network_plugin", "calico"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "pods_ipv4_cidr", "10.100.0.0/16"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "public_ip", "false"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "master_disks.#", "3"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "description", ""),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "api_lb_fip", ""),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "insecure_registries.#", "0"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "labels.#", "0"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "loadbalancer_allowed_cidrs.#", "0"),
					resource.TestCheckResourceAttr("vkcs_kubernetes_cluster_v2.base", "node_groups.#", "0"),

					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.base", "master_flavor", "data.vkcs_compute_flavor.master", "id"),
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.base", "network_id", "vkcs_networking_network.base", "id"),
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.base", "subnet_id", "vkcs_networking_subnet.base", "id"),
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.base", "loadbalancer_subnet_id", "vkcs_networking_subnet.base", "id"),

					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "id"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "uuid"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "external_network_id"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "k8s_config"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "created_at"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "status"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "project_id"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "api_address"),
					resource.TestCheckResourceAttrSet("vkcs_kubernetes_cluster_v2.base", "api_lb_vip"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.full", "master_flavor", "data.vkcs_compute_flavor.master", "id"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("vkcs_kubernetes_cluster_v2.scale", "master_flavor", "data.vkcs_compute_flavor.master", "id"),
				),
			},
			{
				Config: acctest.AccTestRenderConfig(testAccKubernetesClusterV2Scale, map[string]string{
...
const testAccKubernetesClusterV2Base = `
...
// A cluster without worker nodes is not updated to the new version of Kubernetes.
...
resource "vkcs_kubernetes_node_group_v2" "upgrade" {
  cluster_id               = vkcs_kubernetes_cluster_v2.upgrade.id
  name                     = "tfacc-upgrade-v2"
  node_flavor              = data.vkcs_compute_flavor.master.id
