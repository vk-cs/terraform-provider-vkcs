...
func TestAccSFSShareNetwork_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: acctest.AccTestRenderConfig(testAccSFSShareNetworkConfigUpdate, map[string]string{"TestAccSFSShareNetworkConfig": testAccSFSShareNetworkConfig}),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccSFSShareNetwork_secservice(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: acctest.AccTestRenderConfig(testAccSFSShareNetworkConfigSecService1, map[string]string{"TestAccSFSShareNetworkConfig": testAccSFSShareNetworkConfig, "TestAccSFSShareNetworkConfigSecService": testAccSFSShareNetworkConfigSecService}),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: acctest.AccTestRenderConfig(testAccSFSShareNetworkConfigSecService2, map[string]string{"TestAccSFSShareNetworkConfig": testAccSFSShareNetworkConfig, "TestAccSFSShareNetworkConfigSecService": testAccSFSShareNetworkConfigSecService}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSFSShareNetworkExists("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", &sharenetwork),
					resource.TestCheckResourceAttr("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", "name", "test_sharenetwork_secure"),
					resource.TestCheckResourceAttr("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", "description", "share the secure love"),
			...
			{
				Config: acctest.AccTestRenderConfig(testAccSFSShareNetworkConfigSecService3, map[string]string{"TestAccSFSShareNetworkConfig": testAccSFSShareNetworkConfig, "TestAccSFSShareNetworkConfigSecService": testAccSFSShareNetworkConfigSecService}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSFSShareNetworkExists("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", &sharenetwork),
					resource.TestCheckResourceAttr("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", "name", "test_sharenetwork_secure"),
					resource.TestCheckResourceAttr("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", "description", "share the secure love"),
			...
			{
				Config: acctest.AccTestRenderConfig(testAccSFSShareNetworkConfigSecService4, map[string]string{"TestAccSFSShareNetworkConfig": testAccSFSShareNetworkConfig, "TestAccSFSShareNetworkConfigSecService": testAccSFSShareNetworkConfigSecService}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSFSShareNetworkExists("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", &sharenetwork),
					resource.TestCheckResourceAttr("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", "name", "test_sharenetwork"),
					resource.TestCheckResourceAttr("vkcs_sharedfilesystem_sharenetwork.sharenetwork_1", "description", "share the love"),
...
func testAccCheckSFSShareNetworkSecSvcExists(n string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		apiSecurityServiceIDs := sharedfilesystem.ResourceSharedFilesystemShareNetworkSecSvcToArray(&securityServiceList)
