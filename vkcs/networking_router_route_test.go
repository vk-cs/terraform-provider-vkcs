...
func TestResourceNetworkingRouterRouteBuildID(t *testing.T) {
	expected := "d190e837-090a-44f2-adcf-07f9fd392931-route-10.11.12.0/24-192.168.0.111"

	actual := resourceNetworkingRouterRouteBuildID(
...
func TestResourceNetworkingRouterRouteParseValidID(t *testing.T) {
	...
	actualRouterID, actualDstCIDR, actualNextHop, err := resourceNetworkingRouterRouteParseID(routeID)
...
func TestResourceNetworkingRouterRouteParseIDInvalidFirstPart(t *testing.T) {
	routeID := "123-router"
...
func TestResourceNetworkingRouterRouteParseIDInvalidLastPart(t *testing.T) {
