...
import (
	...
	kubernetesv2 "github.com/vk-cs/terraform-provider-vkcs/vkcs/kubernetes/v2"
...
func (p *vkcsProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		kubernetesv2.NewKubernetesClusterV2DataSource,
		kubernetesv2.NewKubernetesNodeGroupV2DataSource,
...
func (p *vkcsProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		kubernetesv2.NewKubernetesClusterV2Resource,
		kubernetesv2.NewKubernetesNodeGroupV2Resource,
