...
func (p *vkcsProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		kubernetes.NewKubernetesAddonV2DataSource,
		kubernetes.NewKubernetesAddonsV2DataSource,
		kubernetes.NewKubernetesClusterAddonV2DataSource,
		...
		kubernetes.NewKubernetesSecurityPolicyTemplateV2DataSource,
		kubernetes.NewKubernetesSecurityPolicyTemplatesV2DataSource,
