...
func TestResourceNetworkingSubnetRouteBuildID(t *testing.T) {
	expected := "2f6a2fa9-b2ef-4f74-a5ce-4132d1c35455-route-10.13.14.0/24-192.168.0.112"

	actual := resourceNetworkingSubnetRouteBuildID(
...
func TestResourceNetworkingSubnetRouteParseValidID(t *testing.T) {
	...
	actualRouterID, actualDstCIDR, actualNextHop, err := resourceNetworkingSubnetRouteParseID(routeID)
...
func TestResourceNetworkingSubnetRouteParseIDInvalidFirstPart(t *testing.T) {
	routeID := "123-router"
...
func TestResourceNetworkingSubnetRouteParseIDInvalidLastPart(t *testing.T) {
