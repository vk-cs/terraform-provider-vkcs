...
- `master_flavor` **required** *string* &rarr;  The flavor ID used for master nodes. Use STD3-* flavor for clusters in PA2 availability zone. Changing this triggers a rolling upgrade of the control plane.
